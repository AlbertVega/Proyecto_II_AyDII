...
void Checkers::start()
{
	...
	sf::Image image;
	if(!image.loadFromFile("/home/albert/Documentos/GitHub/checkers/resources/Checkerboard_8x8_125px.png"))
	...
	// load the text font
	sf::Font font;
	if(!font.loadFromFile("/home/albert/Documentos/GitHub/checkers/resources/ENGR.TTF"))
